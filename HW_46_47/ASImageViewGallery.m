...
@interface ASImageViewGallery () <MHFacebookImageViewerDatasource>
...
@implementation ASImageViewGallery

- (void)openVideoAction:(UIButton *)sender {
    
    //UIButton *btn = (UIButton *)sender;
    
    //TTVideo *video = [self.images objectAtIndex:btn.tag];
...
-  (NSURL*) imageURLAtIndex:(NSInteger)index imageViewer:(MHFacebookImageViewer *)imageViewer {
    ...
    if ([[self.images objectAtIndex:index] isKindOfClass:[ASPhoto class]]) {
        ASPhoto *photo = [self.images objectAtIndex:index];
